import{N as O}from"./Thing-Cly7-K3X.js";import{d as E,c as h,a as _,b as c,i as G,e as H,f as b,g as u,h as x,j as m,u as N,k as T,l as y,p as S,t as V,m as K,n as A,o as F,q as W,r as U,s as Z,v as o,w as r,x as i,F as J,y as C,z as Q,A as X,B as Y,C as a,D as ee}from"./index-B-b8ZYXL.js";function oe(t){const{textColor2:l,cardColor:e,modalColor:s,popoverColor:p,dividerColor:g,borderRadius:f,fontSize:d,hoverColor:v}=t;return{textColor:l,color:e,colorHover:v,colorModal:s,colorHoverModal:h(s,v),colorPopover:p,colorHoverPopover:h(p,v),borderColor:g,borderColorModal:h(s,g),borderColorPopover:h(p,g),borderRadius:f,fontSize:d}}const re={common:E,self:oe},te=_([c("list",`
