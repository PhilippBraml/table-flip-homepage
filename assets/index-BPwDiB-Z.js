import{N as E}from"./Thing-BxcovtSV.js";import{d as H,c as f,a as _,b as s,i as N,e as T,f as b,g as i,h as x,j as c,u as V,k as S,l as C,p as G,t as A,m as Z,n as F,o as K,q as U,r as W,s as q,v as n,w as a,x as d,F as Q,y,z as X,A as Y,B as m,C as J}from"./index-DKhKS5Hd.js";function oo(e){const{textColor2:r,cardColor:o,modalColor:l,popoverColor:u,dividerColor:v,borderRadius:h,fontSize:t,hoverColor:g}=e;return{textColor:r,color:o,colorHover:g,colorModal:l,colorHoverModal:f(l,g),colorPopover:u,colorHoverPopover:f(u,g),borderColor:v,borderColorModal:f(l,v),borderColorPopover:f(u,v),borderRadius:h,fontSize:t}}const eo={common:H,self:oo},ro=_([s("list",`
